export function Hero() {
    ...
    <div class="container w-full justify-center relative flex-nowrap flex-col items-center lg:flex-row ">
        <div class="lg:w-3/6 lg:text-left flex flex-col justify-center gap-6 w-full text-center">
            ...
            <a href="#join" class="uppercase lg:w-auto lg:ml-0 lg:mr-auto btn md:w-min text-nowrap md:w-5/6 w-full mx-auto">Join Now</a>
        </div>
    ...
    <a href="#about" class="btn-arrow absolute top-full z-10"/>
    `;
